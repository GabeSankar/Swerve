...
class SwerveKnO{
    public:
    SwerveKnO(units::length::meter_t startingx,units::length::meter_t startingy, units::angle::degree_t startingangle,units::angle::degree_t gyroAngle);
    ...
    void SwerveOdometryGetPose(units::angle::degree_t gyroAngle);
